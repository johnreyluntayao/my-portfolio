...
const GlowingButton = ({title, icon, position, functionClick, moreClasses}: {
  ...
  return (
    ...
    <button className={`inline-flex lg:h-14 h-12 w-48 animate-shimmer items-center justify-center rounded-full bg-[length:200%_100%] px-6 gap-2 font-base transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-white ${moreClasses}`}>
