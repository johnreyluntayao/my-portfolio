...
const TechStack = () => {
  return (
    <section className="relative -mt-14 py-16 bg-science-blue-900 mb-16 md:mb-24 lg:mb-32 -mx-mobile-margin md:-mx-tablet-margin lg:-mx-laptop-margin xl:-mx-desktop-margin">
