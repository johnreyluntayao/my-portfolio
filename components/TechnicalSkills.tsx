...
const TechnicalSkills = () => {
  ...
  const renderCompanies = () => {
    return companies.map((company) => (
      <div key={company.id} className="flex items-center gap-2 sm:gap-3 bg-white/20 rounded-lg p-2 sm:p-3 shadow-md hover:bg-white/30 transition duration-300">
        <img
          src={company.img}
          alt={company.name}
  ...
  return (
    <section ref={scrollRef} className="scroller relative z-20 max-w-max overflow-hidden bg-gradient-to-r from-science-blue-900 to-science-blue-500 h-auto min-h-[50vh] -mt-14 flex justify-center items-center py-8 mb-16">
