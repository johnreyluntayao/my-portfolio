...
const TechImplementation = ({ id }: { id: number }) => {
  return (
    <section className={`relative py-16 bg-science-blue-900 -mx-mobile-margin md:-mx-tablet-margin lg:-mx-laptop-margin xl:-mx-desktop-margin my-16 md:my-24 lg:my-32`}>
